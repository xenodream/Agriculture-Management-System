...
import { useGetAllWorkersMachineryUsageQuery } from "../redux/slices/adminApiSlice";
...
const WorkersMachineryUsage = () => {
  const { data, isLoading, isError } = useGetAllWorkersMachineryUsageQuery();
  ...
  if (isLoading) {
    return (
      <>
        ...
        <Section>
          <Header>
            <Title>Zużycie zasobów</Title>
            <Desc>Monoitorowanie użycia zasobów</Desc>
          </Header>
          <NewSection>
            <AddSection>
              <StyledLink to="/worker" onClick={handleScroll}>
                <AddButton>-</AddButton>
              </StyledLink>
          ...
          <MachineSection>
            <PanelSectionHeader>
              <PanelSectionTitle
                ...
                description="Wykorzystanie zasobów podczas pracy"
              ></PanelSectionTitle>
            </PanelSectionHeader>
